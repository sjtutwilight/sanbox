...
final class WalletRequestSupport {

    private WalletRequestSupport() {
    }
    ...
    static boolean boolValue(Object value, boolean defaultValue) {
    ...
    static Duration durationValue(Object value, Duration defaultValue) {
